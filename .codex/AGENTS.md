...
- Optimize expected value: outcome per total cost while meeting scope, correctness, and quality. Count execution, coordination, context, verification, retries, repair, and delays that block other work. Compare local execution with a delegate sized to the work; prefer local execution when delegation has no supported advantage.
